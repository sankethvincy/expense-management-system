...
<script>
    ...
    $('#moneyFormat').maskMoney({
        ...
        prefix:'<?php echo e(auth()->user()->currency->symbol); ?>',
        // The thousands separator
        thousands:'<?php echo e(auth()->user()->currency->money_format_thousands); ?>',
        // The decimal separator
        decimal:'<?php echo e(auth()->user()->currency->money_format_decimal); ?>'
    }); 
